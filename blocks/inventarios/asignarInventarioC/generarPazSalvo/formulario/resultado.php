...
class registrarForm {
	...
	function miForm() {
		...
		$supervisor = $_REQUEST ['funcionario'];
		
		$variables = array (
				
				"funcionario" => $supervisor,
				"contratista" => $arregloDatos
		);
		...
		$atributos ['tipoEtiqueta'] = 'inicio';
		$atributos ["leyenda"] = "Elementos Prestamo Actualmente al Contratista " . $arregloDatos  . " - " . $nombreContratista [0] [0];
		...
		$valorCodificado .= "&documentoContratista=" . $arregloDatos [0];
