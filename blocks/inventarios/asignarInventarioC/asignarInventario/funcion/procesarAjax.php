...
if ($_REQUEST ['funcion'] = "ConsultarInventario") {
    ...
    $_REQUEST ['funcionario']=str_replace("CC", "",$_REQUEST ['funcionario']);

    $arreglo2= $_REQUEST['arreglo2'];

    $cadenaSql = $this->sql->getCadenaSql('consultarElementosSupervisor', $_REQUEST ['funcionario'], $arreglo2);
