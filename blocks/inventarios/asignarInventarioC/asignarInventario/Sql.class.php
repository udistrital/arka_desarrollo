...
//-----------------------------** Cláusulas del caso de uso**----------------------------------//
            ...
            case "consultarElementosSupervisor" :
                $cadenaSql = "SELECT salida.id_entrada as salida,elemento.id_entrada,id_elemento, nivel, marca, elemento_individual.placa,elemento_individual.serie, valor, subtotal_sin_iva, ";
