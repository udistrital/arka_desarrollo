...
class registrarForm {
    ...
    function miForm() {
        ...
        $datosfuncionario = $esteRecursoDB->ejecutarAcceso($cadenaSql2, "busqueda");
        
        $datosfuncionarioNombre = $datosfuncionario [0][1];
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Inventario  : CC. " . $arregloDatos [0] . "    " . $datosfuncionarioNombre;
