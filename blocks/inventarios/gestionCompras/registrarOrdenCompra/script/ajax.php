...
$cadenaACodificar17 .= $cadenaACodificar16 . "&funcion=vigencia_disponibilidad";
...
$cadenaACodificar18 .= $cadenaACodificar16 . "&funcion=rubros";
...
<script type='text/javascript'>
    ...
    $(function () {
        ...
        $("#<?php echo $this->campoSeguro('selec_dependencia') ?>").change(function () {
            datosDependencia();
        });
