...
// 		var_dump($orden);
		$datosOrden = array (
				...
				'iva' => $orden [0] ['iva'],
				'total' => $orden [0] ['total'],
				'asignacionOrdenador' => $orden [0] ['id_ordenador_encargado'],
				'id_ordenador' => $orden [0] ['id_ordenador_encargado'], 
				'sede'=>$orden [0] ['sede']		 
		);
		...
		$cadenaSql = $this->miSql->getCadenaSql ( 'informacion_ordenador', $orden [0] ['id_ordenador_encargado'] );
