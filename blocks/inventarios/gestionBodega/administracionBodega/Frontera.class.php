    ...
    function html() {
        ...
        if (isset($_REQUEST ['opcion'])) {
            ...
            switch ($_REQUEST ['opcion']) {
                ...
                case "solicitarSalida" :

                    if ($_REQUEST['botonImprimir'] == 'true') {
                        include_once ($this->ruta . "/formulario/reporte.php");
                        exit;
                    }
                    
                    if ($_REQUEST['botonAceptar'] == 'true') {
                ...
                case "mensaje2" :
                    include_once ($this->ruta . "/formulario/descarga.php");
                    break;
            }
        } else {
