...
$(function() {
$("#administracionBodega").submit(function() {
...
$("#<?php echo $this->campoSeguro('funcionario_solicita') ?>").select2();
$("#<?php echo $this->campoSeguro('funcionario_recibe') ?>").select2();
$("#<?php echo $this->campoSeguro('contratista_recibe') ?>").select2();
$('#<?php echo $this->campoSeguro('sede2') ?>').width(210);
$("#<?php echo $this->campoSeguro('sede2') ?>").select2();
$('#<?php echo $this->campoSeguro('dependencia2') ?>').width(210);
...
$('#<?php echo $this->campoSeguro('reportes') ?>').width(250);
$("#<?php echo $this->campoSeguro('reportes') ?>").select2();
...
height: 470,
width: 900,
title: "Instrucción llevar a Bodega",
autoOpen: true,
});
...
$( "#ventanaEmergente2" ).dialog({
height: 470,
width: 1500,
title: "Confirmación elementos a Bodega",
autoOpen: false,
});
