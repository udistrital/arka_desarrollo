...
class Funcion {
    ...
    function regitrarSalida() {
        include_once ($this->ruta . "funcion/registrarSalida.php");
    }
function documentoPDF2() {
        include_once ($this->ruta . "funcion/documentoPdf2.php");
    }
    function action() {
...
// 		
        ...
        if (isset($_REQUEST ['procesarAjax'])) {
            ...
            if ($_REQUEST ['opcion'] == 'RegistrarSalida') {
                $this->regitrarSalida();
            }

            if (isset($_REQUEST ['botonGenerarPdf2'])) {
                $this->documentoPDF2();
            }
