...
use  inventarios\gestionBodega\reporteConsumo\Sql;
...
if ($_REQUEST ['funcion'] == 'Consulta') {
    ...
    for ($key = 0; $key < $to; $key++) {
        ...
        $resultadoFinal[] = array(
            ...
            'funcionario' => "<center>" . $items[$key]['funcionario']. "</center>",
            'sede' => "<center>" . $items[$key]['sede']. "</center>",
            'dependencia' => "<center>" . $items[$key]['dependencia']. "</center>",
            'espacio' => "<center>" . $items[$key]['espacio']. "</center>",
