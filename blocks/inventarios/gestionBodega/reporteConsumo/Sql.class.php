...
namespace inventarios\gestionBodega\reporteConsumo;
...
//-----------------------------** Cláusulas del caso de uso**----------------------------------//
            ...
            case "mostrarInfoDepreciar":
                ...
                $cadenaSql .= " af.\"FUN_NOMBRE\" funcionario, ";
                $cadenaSql .= " espacios.\"ESF_NOMBRE_ESPACIO\" espacio, ";
                ...
                $cadenaSql .= " JOIN arka_parametros.arka_dependencia as dependencia ON dependencia.\"ESF_ID_ESPACIO\"=elemento_individual.ubicacion_elemento  ";
