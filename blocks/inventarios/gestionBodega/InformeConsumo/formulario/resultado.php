...
class registrarForm {
    ...
    function miForm() {
        ...
        if ($resultado_periodo) {
            ...
            $cadenaSql = $this->miSql->getCadenaSql('consultarFuncionariosaCargoElementos', $arregloConsulta);
            ...
            ";
                    ...
                    <td><center>" . $resultado [$i] ['nombre_espacio'] . "</center></td>
					...
					";
                        ...
                        $atributos ['valor'] = serialize(array(
                            ...
                            "cod_espacio" => $resultado [$i] ['codigo_espacio'],
            ...
            if ($resultado) {
                ...
                // -----------------CONTROL: Botón ----------------------------------------------------------------
                $esteCampo = 'botonGenerarPdfConsolidado';
                $atributos ["id"] = $esteCampo;
                $atributos ["tabIndex"] = $tab;
                $atributos ["tipo"] = 'boton';
                // submit: no se coloca si se desea un tipo button genérico
