...
namespace inventarios\gestionBodega\informeConsumo;
...
class Funcion {
    ...
    function documentoPDFConsolidado() {
        include_once ($this->ruta . "funcion/documentoPdfConsolidado.php");
    }
    ...
    function action() {
        ...
        if (isset($_REQUEST ['procesarAjax'])) {
            ...
            if (isset($_REQUEST ['botonGenerarPdf']) && $_REQUEST ['botonGenerarPdf'] == 'true') {
                if($_REQUEST['sedeReporte']!=null){
                    $this->documentoPDF();
                }
                else{
                    $opcion="errorSede";
                    redireccion::redireccionar($opcion,$_REQUEST ['funcionario']);
                }
               
                
            }
            if (isset($_REQUEST ['botonGenerarPdfConsolidado']) && $_REQUEST ['botonGenerarPdfConsolidado'] == 'true') {

                $this->documentoPDFConsolidado();
            }
