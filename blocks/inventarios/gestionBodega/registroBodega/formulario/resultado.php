...
class registrarForm {
    ...
    function miForm() {
        ...
        $cadenaSql = $this->miSql->getCadenaSql('consultarElementoBodega', $arreglo);
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Consulta Entradas a Bodega";
        ...
        if ($elemento) {
            ...
            echo "<thead>
			    ...
			    <th><center>vig</center></th>	
                            <th><center>Vigencia</center></th>
                            <th><center>Nit</center></th>
			    <th><center>Proveedor</center></th>
                            <th><center>Identiticación<br>Supervisor</center></th>
            ...
            for ($i = 0; $i < count($elemento); $i ++) {
                ...
                $mostrarHtml = "<tr>
                                <td>" . $elemento [$i] ['con'] . "</td>
		    		<td>" . $elemento [$i] ['vig'] . "</td>
                                <td>" . $elemento [$i] ['consecutivo'] . "</td>
		  		<td>" . $elemento [$i] ['proveedor'] . "</center></td>
                                <td>" . $elemento [$i] ['nombre_proveedor'] . "</td>
                                <td>" . $elemento [$i] ['supervisor'] . "</td>
                                <td>" . $elemento [$i] ['nombre_supervisor'] . "</td>
                                <td>" . $elemento [$i] ['sede'] . "</td>
            ...
            $valorCodificado .= "&opcion=solicitarBodega";
