...
// ---------------- SECCION: Controles del Formulario -----------------------------------------------
        ...
        if ($datos) {
            ...
            for ($i = 0; $i < count($datos); $i ++) {
                ...
                $variable_documento .= "&id_entrada=" . $datos[$i] ['id_entrada'];
                $variable_documento = $this->miConfigurador->fabricaConexiones->crypto->codificar_url($variable_documento, $directorio);

                $mostrarHtml = "<tr>
                    <td><center>(" . $datos [$i] ['vigencia'] . ")-" . $datos [$i] ['consecutivo'] . "</center></td>
                    <td><center>" . $datos [$i] ['clase_entrada'] . "</center></td>
                    <td><center>" . $datos [$i] ['proveedor'] . "</center></td>
                    <td><center>" . $datos [$i] ['nombre_proveedor'] . "</center></td>
                    <td><center>" . $datos [$i] ['estado_entrada'] . "</center></td>
                          <td><center>
