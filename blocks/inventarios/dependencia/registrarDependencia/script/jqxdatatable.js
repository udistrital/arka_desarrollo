...
(function (b) {
    ...
    b.extend(b.jqx._jqxDataTable.prototype, {defineInstance: function () {
            ...
            if ((l.element.nodeName.toLowerCase() == "table") || b(l.element).children("table").length > 0) {
                ...
                l.host = m;
                l.host.data(q);
                var o = {dataFields: w, localdata: z, datatype: "array"};
            ...
            var k = this.hScrollBar[0].style.visibility;
            if (!l) {
            ...
            if (!p && i > g && (this.source.records.length > 0 || this.source.hierarchy.length > 0)) {
            ...
            var n = this.table ? this.table.width() : 0;
            if (n > 3) {
                n -= 3
            }
            var c = parseInt(this.host.css("border-left-width")) + parseInt(this.host.css("border-right-width"));
            var q = c + this.host.width() - m;
            if (n > q && !o) {
                this.hScrollBar[0].style.visibility = e;
                this.hScrollBar.jqxScrollBar({max: n - q});
                m = 4 + parseInt(d);
                if (!p) {
                    if (i > g - m + 4 && (this.source.records.length > 0 || this.source.hierarchy.length > 0)) {
                        this.hScrollBar.jqxScrollBar({max: c + n - q});
                        var f = this.vScrollBar[0].style.visibility === "hidden";
                        this.vScrollBar[0].style.visibility = e;
                        this._updatecolumnwidths();
                        if (f) {
                            this.hScrollBar.jqxScrollBar({max: n - q + m + c})
                        }
                        var j = this.table ? this.table.width() : 0;
                        if (j > 3) {
                            j -= 3
                        }
                        if (j != n) {
                            if (j < q) {
                                this.hScrollBar.jqxScrollBar({max: c + j - q});
                                this.hScrollBar[0].style.visibility = "hidden";
                                m = 0
                            }
                        }
                    }
                    this.vScrollBar.jqxScrollBar({max: i - g + m})
                }
            } else {
                this.hScrollBar[0].style.visibility = "hidden"
            }
            ...
            if (!this.pagerRenderer) {
                ...
                var f = function (s, E) {
                    ...
                    if (n.pagerMode != "default") {
                        ...
                        A.jqxDropDownList({_checkForHiddenParent: false, rtl: n.rtl, disabled: n.disabled, source: u, enableBrowserBoundsDetection: true, keyboardSelection: false, autoDropDownHeight: true, width: 44, height: 16, theme: n.theme});
                        var B = 0;
                        ...
                        this.addHandler(A, "select", function (K) {
                            if (K.args) {
                                ...
                                if (G !== n.dataview.pagenum || parseInt(H) !== parseInt(J)) {
                                    n._raiseEvent("pageSizeChanged", {pagenum: G, oldpageSize: J, pageSize: n.dataview.pagesize});
                                    var F = n.goToPage(G);
                                    if (!F) {
            ...
            this.addHandler(this.table, d, function (A) {
                ...
                if (E !== undefined) {
                    ...
                    if (k) {
                        ...
                        e._raiseEvent("rowClick", {index: B, boundIndex: s, key: E, row: k.row, originalEvent: A, dataField: j.datafield});
                        ...
                        if (e._lastSelectedKey == E && (n - e.clickTime.getTime() < v)) {
                            e._raiseEvent("rowDoubleClick", {index: B, boundIndex: s, key: E, row: k.row, originalEvent: A, dataField: j.datafield});
                            z = true;
                            if (A.preventDefault) {
                                A.preventDefault()
                            }
                    ...
                    if (p.className.indexOf("jqx-grid-group") >= 0) {
                        ...
                        if (A.target && A.target.className.indexOf && A.target.className.indexOf("jqx-grid-group") >= 0 && e.treeGrid) {
                            if (!k.expanded) {
                            ...
                            if (A.target && A.target.className.indexOf && A.target.className.indexOf("checkbox") >= 0 && e.treeGrid) {
                                if (!k.checked) {
            ...
            var d = {leaf: "leaf", parent: "parent", expanded: "expanded", checked: "checked", selected: "selected", level: "level", icon: "icon", data: "data"};
                                    ...
                                    if (!X.shiftKey && !y) {
                                        ...
                                        if (N) {
                                            ...
                                            if (F) {
                                                ...
                                                this._raiseEvent("rowSelect", {key: F, index: L, boundIndex: C, row: this.rowsByKey[F]});
            ...
            M.removeClass(ad("jqx-grid-cell-selected"));
            M.removeClass(ad("jqx-fill-state-pressed"));
            n.removeClass(ad("jqx-grid-cell-selected"));
            n.removeClass(ad("jqx-fill-state-pressed"));
            M.removeClass(ad("jqx-grid-cell-hover"));
            M.removeClass(ad("jqx-fill-state-hover"));
            n.removeClass(ad("jqx-grid-cell-hover"));
            n.removeClass(ad("jqx-fill-state-hover"));
            var E = "cell";
            var B = 1;
            var K = "column";
            var z = 1;
            ...
            b.each(p, function (ag) {
                ...
                var ah = function (am) {
                    ...
                    am.removeClass(ao("jqx-cell"));
                    am.removeClass(ao("jqx-grid-cell-selected"));
                    am.removeClass(ao("jqx-fill-state-pressed"));
                    am.removeClass(ao("jqx-grid-cell-hover"));
                    am.removeClass(ao("jqx-fill-state-hover"));
                ...
                if (t != "json" && t != "xml") {
                    ...
                    i(K, al, true, false, this, s, ag);
                    z++;
                    i(E, ak, false, false, this, s, ag);
                    if (s.altRows) {
                        E = "cellalt" + B;
                        i(E, j, false, true, this, s, ag)
                    }
                    if (this.customCellStyles) {
                        ...
                        for (var ae in af.customCellStyles) {
                            ak.addClass(af.customCellStyles[ae]);
                            i(E + af.customCellStyles[ae], ak, false, false, this, s, ag, true, ae);
                            ak.removeClass(af.customCellStyles[ae])
                        }
                    }
                    B++
            ...
            var e = this.getColumn(r);
            this._raiseEvent("cellValueChanged", {value: v, oldValue: n, dataField: r, displayField: e.displayfield, key: C, boundIndex: k, index: B, row: this.rowsByKey[C]});
            if (this.editable) {
            ...
            if (B) {
                ...
                for (var y = 0; y < h.length; y++) {
                    ...
                    b(d).css("padding", "0px");
                    cellContent = "<div style='height:" + t + "px; width: 100%; overflow: hidden; border-radius: 0px; -moz-border-radius: 0px; -webkit-border-radius: 0px; z-index: 9999;'></div>";
                    var r = this.getCellTextByKey(E, g.displayfield);
                    ...
                    switch (g.columntype) {
                        ...
                        case"default":
                            ...
                            j.addClass(this.toThemeProperty("jqx-cell-editor"));
                            ...
                            if (!g.editable) {
                                ...
                                j.addClass(this.toThemeProperty("jqx-fill-state-disabled"))
                            } else {
                                if (!p) {
                                    p = true;
                            ...
                            this._editors.push({column: g, editor: j});
                            if (g.cellsFormat != "") {
            ...
            this._raiseEvent("rowBeginEdit", {key: E, index: D, boundIndex: n, row: this.rowsByKey[E]});
            if (C) {
                var m = this.rowsByKey[E];
                var v = null;
                var l = null;
                ...
                this._raiseEvent("cellBeginEdit", {value: v, displayValue: l, key: E, index: D, dataField: q.datafield, displayField: q.displayfield, boundIndex: n, row: this.rowsByKey[E]})
            }
            ...
            for (var h = 0; h < m.length; h++) {
                ...
                if (f.validation) {
                    ...
                    var e = f.datafield;
                    try {
                        var r = f.validation({value: o, row: c, datafield: f.datafield, displayfield: f.displayfield, column: f}, o);
                    ...
                    if (d) {
                        ...
                        var r = function () {
                            ...
                            for (var w = 0; w < m.length; w++) {
                                ...
                                if (B != t) {
                                    k.beginUpdate();
                                    k._raiseEvent("cellValueChanged", {value: B, oldValue: t, dataField: u.datafield, displayField: u.displayfield, key: o, index: l, row: s});
                                    k.endUpdate(false)
                                }
                            }
                        };
            ...
            if (g.editSettings.editSingleCell) {
                ...
                g._raiseEvent("cellEndEdit", {value: k, displayValue: j, key: l, index: d, dataField: g.editColumn.datafield, displayField: g.editColumn.displayfield, boundIndex: i, row: g.rowsByKey[l]})
            }
            ...
            var h = this;
            var j = b("<div style='position: relative; margin: 4px;'><input style='height: 22px; direction: ltr;' role='textbox' type='text'/><div style='cursor: pointer; height: 100%;'><div></div></div></div>");
            j.height(22);
            var o = j.find("input");
            ...
            if (c.jqxDropDownList) {
                c.jqxDropDownList({theme: this.theme, enableBrowserBoundsDetection: true, autoDropDownHeight: p, rtl: h.rtl, dropDownWidth: 220, selectedIndex: 0, width: "auto", height: 20, source: d, displayMember: "label", valueMember: "value"})
            }
            ...
            var e = function () {
                ...
                b.each(h.columns.records, function () {
                    ...
                    q.click(function () {
                        ...
                        t.jqxDropDownList({theme: h.theme, enableBrowserBoundsDetection: true, renderMode: "simple", arrowSize: 0, selectedIndex: index, rtl: h.rtl, dropDownWidth: 230, dropDownHeight: 180, width: 20, height: 20, source: s, selectionRenderer: function () {
                        ...
                        t.find("div").removeAttr("tabindex");
                        t.jqxDropDownList("open")
                    });
            ...
            if (this.editable) {
                if (this.editKey != null) {
                    var L = this.endroweditbykey(this.editKey)
                }
            }
            if (this.treeGrid) {
            ...
            var G = this.toTP("jqx-cell") + " " + this.toTP("jqx-widget-content");
            if (this.rtl) {
                G += " " + this.toTP("jqx-cell-rtl")
            }
            var J = this.columns.records.length;
            var am = b.jqx.browser.msie && b.jqx.browser.version < 8;
            if (am) {
                this.host.attr("hideFocus", "true")
            }
            var Q = aa.groups.length;
            var ah = new Array();
            ...
            if (aa.groups && aa.groups.length > 0) {
                var O = this.pageable ? this.dataview.pagesize * this.dataview.pagenum : 0;
                var y = function (w) {
                    var aq = 0;
                    var i = new Array();
                ...
                if (this.pageSizeMode === "root") {
                    var v = aa.source.getGroupedRecords(aa.groups, "records", "label", null, "data", null, "parent", k, 0);
                    aa.rootRecordsLength = v.length;
                    v = y(v)
                } else {
                    var v = aa.source.getGroupedRecords(aa.groups, "records", "label", null, "data", null, "parent", u, O)
                }
                var x = function (j, w) {
                ...
                var ah = x.call(aa, v, new Array());
                u = ah;
                this.rowsByKey = new Array();
                for (var al = 0; al < u.length; al++) {
                    var F = u[al];
                    this.rowsByKey[F.uid] = F
                }
            }
            var ah = u;
            this.renderedRecords = ah;
            var T = ah.length;
            var U = this.tableZIndex;
            var an = 0;
            var Z = 0;
            if (am) {
                for (var ak = 0; ak < J; ak++) {
                    var Y = this.columns.records[ak];
                    var e = Y.width;
                    if (e < Y.minwidth) {
                        e = Y.minwidth
                    }
                    ...
                    var l = b('<table><tr><td role="gridcell" style="max-width: ' + e + "px; width:" + e + 'px;" class="' + G + '"></td></tr></table>');
                    b(document.body).append(l);
                    var n = l.find("td");
                    an = 1 + parseInt(n.css("padding-left")) + parseInt(n.css("padding-right"));
                    l.remove();
                    break
                }
            }
            var aj = this.rtl ? " " + this.toTP("jqx-grid-table-rtl") : "";
            var A = "<table cellspacing='0' cellpadding='0' class='" + this.toTP("jqx-grid-table") + aj + "' id='table" + this.element.id + "'><colgroup>";
            ...
            for (var ak = 0; ak < J; ak++) {
                ...
                if (am) {
                    ...
                    if (Y.rowDetailscolumn) {
                        var ab = ab + 4;
                        ao += "<col style='max-width: " + ab + "px; width: " + ab + "px;'>";
                        A += "<col style='max-width: " + ab + "px; width: " + ab + "px;'>"
                    } else {
                        ao += "<col style='max-width: " + ab + "px; width: " + ab + "px;'>";
                        A += "<col style='max-width: " + ab + "px; width: " + ab + "px;'>"
                    }
                    ...
                    A += "<col style='max-width: " + e + "px; width: " + e + "px;'>"
                }
                Z += e
            }
            A += "</colgroup>";
            ...
            if (T === 0) {
                ...
                if (this.filterable) {
                    ...
                    m -= this.filterHeight + this.filterHeight * af.length * B
                }
                if (this.showStatusBar) {
                    m -= this.statusBarHeight
                }
                ...
                var l = '<td colspan="' + this.columns.records.length + '" role="gridcell" style="border: none; min-height: ' + m + "px; height: " + m + "px; max-width:" + Z + "px; width:" + Z + "px;";
                var G = this.toTP("jqx-cell") + " " + this.toTP("jqx-grid-cell") + " " + this.toTP("jqx-item");
                G += " " + this.toTP("jqx-center-align");
                l += '" class="' + G + '">';
            ...
            for (var al = 0; al < ah.length; al++) {
                ...
                var K = F.uid;
                if (undefined === F.uid) {
                    F.uid = this.dataview.generatekey()
                }
                var o = '<tr data-key="' + K + '" role="row" id="row' + al + this.element.id + '">';
                var D = '<tr data-key="' + K + '" role="row" id="row' + al + this.element.id + '">';
                if (Q > 0) {
                    if (F.level < Q) {
                        var o = '<tr data-role="row-group" data-key="' + K + '" role="row" id="row' + al + this.element.id + '">';
                        var D = '<tr data-role="row-group" data-key="' + K + '" role="row" id="row' + al + this.element.id + '">'
                    }
                }
                var p = 0;
                var R = 0;
                for (var ak = 0; ak < J; ak++) {
                    ...
                    if (ad.pinned || (this.rtl && this.columns.records[J - 1].pinned)) {
                        g = true
                    }
                    var e = ad.width;
                    if (e < ad.minwidth) {
                    ...
                    if (this.sortcolumn === ad.displayfield) {
                        G += " " + this.toTP("jqx-grid-cell-sort")
                    }
                    if (this.altRows && al % 2 != 0) {
                        G += " " + this.toTP("jqx-grid-cell-alt")
                    }
                    if (this.rtl) {
                        G += " " + this.toTP("jqx-cell-rtl")
                    }
                    ...
                    var l = '<td role="gridcell" ' + N + ' style="max-width:' + e + "px; width:" + e + "px;";
                    var ae = '<td role="gridcell" ' + N + ' style="pointer-events: none; visibility: hidden; border-color: transparent; max-width:' + e + "px; width:" + e + "px;";
                    if (ak == J - 1 && J == 1) {
                    ...
                    if (this.rowinfo[F.uid]) {
                        if (this.rowinfo[F.uid].selected && !ad.rowDetailscolumn) {
                            if (this.editKey !== F.uid) {
                                if (this.selectionMode !== "none") {
                                    G += " " + this.toTP("jqx-grid-cell-selected");
                                    G += " " + this.toTP("jqx-fill-state-pressed")
                                }
                            }
                        }
                        if (this.rowinfo[F.uid].locked) {
                            G += " " + this.toTP("jqx-grid-cell-locked")
                        }
                    }
                    if (!(ad.hidden)) {
                        p += an + e;
                    ...
                    if (!X && ad.rowDetailscolumn) {
                        if (this.rowinfo[F.uid]) {
                            if (!this.rowinfo[F.uid].nodetails) {
                                if (this.rowinfo[F.uid].expanded) {
                                    if (!this.rtl) {
                                        G += " " + this.toTP("jqx-grid-group-expand")
                                    } else {
                                        G += " " + this.toTP("jqx-grid-group-expand-rtl")
                                    }
                                    G += " " + this.toTP("jqx-icon-arrow-down")
                                } else {
                                    if (!this.rtl) {
                                        G += " " + this.toTP("jqx-grid-group-collapse");
                                        G += " " + this.toTP("jqx-icon-arrow-right")
                                    } else {
                                        G += " " + this.toTP("jqx-grid-group-collapse-rtl");
                                        G += " " + this.toTP("jqx-icon-arrow-left")
                                    }
                                }
                            }
                        } else {
                    ...
                    if (!this.autoRowHeight || (this.autoRowHeight && !ad.autoCellHeight)) {
                        G += " " + this.toTP("jqx-grid-cell-nowrap ")
                    }
                    var ai = aa._getcellvalue(ad, F);
                    var f = ad.cellsFormat;
                    if (Q > 0) {
                        if (F.level < Q) {
                            ai = F.label;
                            f = aa.getColumn(aa.groups[F.level]).cellsFormat
                        }
                    }
                    if (f != "") {
                        if (b.jqx.dataFormat) {
                            if (b.jqx.dataFormat.isDate(ai)) {
                                ai = b.jqx.dataFormat.formatdate(ai, f, aa.gridlocalization)
                            } else {
                                if (b.jqx.dataFormat.isNumber(ai) || (!isNaN(parseFloat(ai)) && isFinite(ai))) {
                                    ai = b.jqx.dataFormat.formatnumber(ai, f, aa.gridlocalization)
                                }
                            }
                        }
                    }
                    if (!X) {
                        if (ad.cellclassname != "" && ad.cellclassname) {
                            if (typeof ad.cellclassname == "string") {
                                ...
                                var r = ad.cellclassname(al, ad.datafield, ai, F);
                                if (r) {
                                    G += " " + r
                                }
                            }
                        ...
                        if (ad.cellsRenderer != "" && ad.cellsRenderer) {
                            var d = q.indexOf(F);
                            ai = ad.cellsRenderer(d, ad.datafield, ai, F)
                        }
                    } else {
                        if (this.groupsRenderer) {
                            ai = this.groupsRenderer(ai, F, F.level)
                        }
                    }
                    l += '" class="' + G + '">';
                    l += ai;
                ...
                ao += D;
                if (!this.rowinfo[F.uid]) {
                    this.rowinfo[F.uid] = {group: X, row: F, details: null, detailsHeight: 200, initialized: false, expanded: false}
                }
                if (this.serverProcessing) {
                    this.rowinfo[F.uid].row = F
                }
                if (this.rowDetails) {
                    var E = this.rowinfo[F.uid].detailsHeight;
                    if (this.rowinfo[F.uid]) {
                        if (this.rowinfo[F.uid].expanded) {
                            var ag = '<tr data-role="row-details"><td valign="top" style="pointer-events: auto; overflow: hidden; min-height: ' + E + "px; max-height: " + E + "px; height: " + E + 'px; overflow: hidden; border-left: none; border-right: none;" colspan="' + this.columns.records.length + '" role="gridcell"'
                        } else {
                            var ag = '<tr data-role="row-details" style="display: none;"><td valign="top" style="pointer-events: auto; overflow: hidden; min-height: ' + E + "px; max-height: " + E + "px; height: " + E + 'px; overflow: hidden; border-left: none; border-right: none;" colspan="' + this.columns.records.length + '" role="gridcell"'
                        }
                    } else {
                        var ag = '<tr data-role="row-details" style="display: none;"><td valign="top" style="pointer-events: auto; overflow: hidden; min-height: ' + E + "px; max-height: " + E + "px; height: " + E + 'px; overflow: hidden; border-left: none; border-right: none;" colspan="' + this.columns.records.length + '" role="gridcell"'
                    }
                    var G = this.toTP("jqx-cell") + " " + this.toTP("jqx-grid-cell") + " " + this.toTP("jqx-item");
                    G += " " + this.toTP("jqx-details");
                    G += " " + this.toTP("jqx-reset");
                    ag += '" class="' + G + '"><div style="pointer-events: auto; overflow: hidden; min-height: ' + E + "px; max-height: " + E + "px; height: " + E + 'px;"><div data-role="details"></div></div></td></tr>';
                    A += ag;
                    ao += ag
                }
            }
            ...
            if (g) {
                if (aa.WinJS) {
                    ...
                    aa.table[0].innerHTML = ao + A
                }
                var V = this.table.find("#table" + this.element.id);
                var W = this.table.find("#pinnedtable" + this.element.id);
                W.css("float", "left");
                W.css("pointer-events", "none");
                V.css("float", "left");
                W[0].style.position = "absolute";
                V[0].style.position = "relative";
                V[0].style.zIndex = U - 10;
                W[0].style.zIndex = U + 10;
                this._table = V;
                this._table[0].style.left = "0px";
                this._pinnedTable = W;
                this._pinnedTable[0].style.left = "0px";
                this._pinnedTable[0].style.width = S + "px";
                this._table[0].style.width = S + "px";
                if (this.rtl) {
                    if (S > parseInt(this.element.style.width) && this._haspinned) {
                        this._pinnedTable[0].style.left = 3 - S + parseInt(this.element.style.width) + "px"
                    }
                }
                if (this.rowDetails) {
                    for (var al = 0; al < T; al++) {
                        var F = ah[al];
                        var K = F.uid;
                        if (this.rowinfo[K].details) {
                            var M = b(this._table.children()[1]).children(("[data-key=" + K + "]"));
                            var P = b(this._pinnedTable.children()[1]).children(("[data-key=" + K + "]"));
                            if (M) {
                                var h = P.next();
                                var I = b(b(h).children().children());
                                I.children().detach();
                                I.append(this.rowinfo[F.uid].details)
                            }
                        }
                    }
                }
                ...
                if (T === 0) {
                    this._table[0].style.width = (2 + S) + "px"
                }
            }
            if (T === 0) {
                    ...
                    r.addHandler(x, j, function (O) {
                        ...
                        if (r._handlecolumnsResize) {
                            if (y) {
                                ...
                                Q = 40;
                                if (i >= T + L.width - Q) {
                                    r.resizablecolumn = {columnelement: x, column: L};
            ...
            if (e) {
                ...
                if (this.source && this.source.getAggregatedData) {
                    ...
                    if (d == undefined || d == true) {
                        var m = this.source.getAggregatedData([{name: k.datafield, aggregates: e, formatStrings: f}], this.gridlocalization, h, c);
                        if (this.treeGrid) {
                            ...
                            if (g == 0 || c >= g) {
                                if (m) {
                                    if (m[k.datafield].sum != undefined || m[k.datafield].avg != undefined) {
                                        var j = this.source.getAggregatedData([{name: k.datafield, aggregates: e, formatStrings: f}], this.gridlocalization, s, c);
                        ...
                        var m = this.source.getAggregatedData([{name: k.datafield, aggregates: e}], this.gridlocalization, h, c);
                        if (this.treeGrid && m) {
                            if (m[k.datafield].sum != undefined || m[k.datafield].avg != undefined) {
                                var g = this.source._source.hierarchy && this.source._source.hierarchy.groupingDataFields ? this.source._source.hierarchy.groupingDataFields.length : 0;
                                if (g == 0 || c >= g) {
                                    var j = this.source.getAggregatedData([{name: k.datafield, aggregates: e}], this.gridlocalization, s, c);
                                    if (m[k.datafield].sum != undefined) {
                                        m[k.datafield].sum = j[k.datafield].sum
                                    }
                                    if (m[k.datafield].avg != undefined) {
                                        ...
                                        if (l == "pageSizeOptions") {
                                            ...
                                            if (l == "pageSize") {
                                                ...
                                                if (h !== e.dataview.pagenum || parseInt(k) !== parseInt(d)) {
                                                    e._raiseEvent("pageSizeChanged", {pagenum: k, oldpageSize: d, pageSize: e.dataview.pagesize});
                                                    var m = e.goToPage(h);
                                                    if (!m) {
