...
class Funcion {
	...
	function modificarActa() {
		include_once ($this->ruta . "funcion/modificarActa.php");
	}
	...
	function activarElementos() {
		include_once ($this->ruta . "funcion/activarElementos.php");
	}
	...
	function action() {
		...
		if (isset ( $_REQUEST ['procesarAjax'] )) {
			...
			if ($_REQUEST ['opcion'] == 'activarElementos') {
				$this->activarElementos ();
			}
			
			
			if ($_REQUEST ['opcion'] == 'procesarModificarElementos') {
