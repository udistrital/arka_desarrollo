		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
			{
				...
				if ($_REQUEST ['mensaje'] == 'actualizo') {
					...
					$mensaje = "Se Actualizo el Acta Recibido <br> Número de Acta: " . $_REQUEST ['numero_acta'] . " .";
					...
					$atributos ['texto'] ="¿ Que desea Realizar ?";
					...
					$variable .= "&numero_entrada=".$_REQUEST['numero_acta'];
				...
				if ($_REQUEST ['mensaje'] == 'elimino') {
					
					$mensaje = "Se Eliminó el Acta Recibido <br> Número de Acta: " . $_REQUEST ['numero_acta'] . " .";
				...
				if ($_REQUEST ['mensaje'] == 'errorEliminar') {
					...
					$mensaje = "No Se Pudo Eliminar el Acta de Recibido";
