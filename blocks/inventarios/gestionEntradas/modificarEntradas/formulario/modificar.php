...
class registrarForm {
    ...
    function miForm() {
        ...
        $datos = array(
            ...
            'proveedor' => ($datosEntrada [0] ['proveedor'] != '0') ? $datosEntrada [0] ['nom_razon'] : '',
            'id_proveedor' => ($datosEntrada [0] ['proveedor'] != '0') ? $datosEntrada [0] ['proveedor'] : '',
