		...
		echo $this->miFormulario->agrupacion ( 'inicio', $atributos );
		{
            ...
            <tbody>";
				...
				for($i = 0; $i < count ( $actas ); $i ++) {
					...
					$variable .= "&numero_acta=" . $actas [$i] ['id_actarecibido'];
					...
					$mostrarHtml = "<tr>
                    <td><center>" . $actas [$i] ['id_actarecibido'] . "</center></td>
                    <td><center>" . $actas [$i] ['fecha_registro'] . "</center></td>
                    <td><center>" . $actas [$i] ['nit_proveedor'] . "</center></td>
                    <td><center>" . $actas [$i] ['nombre_proveedor'] . "</center></td>
                    <td><center>
                    	<a href='" . $variable . "'>
