		...
		echo $this->miFormulario->agrupacion ( 'inicio', $atributos );
		{
            ...
            <tbody>";
				...
				for($i = 0; $i < count ( $actas ); $i ++) {
					...
					$mostrarHtml = "<tr>
                    <td><center>" . $actas [$i] [0] . "</center></td>
                    <td><center>" . $actas [$i] [1] . "</center></td>
                    <td><center>" . $actas [$i] [2] . "</center></td>
                    <td><center>" . $actas [$i] [3] . "</center></td>
                    <td><center>
                    	<a href='" . $variable . "'>
				...
				$mensaje = "No Se Encontraron<br>Actas de Recibido Registradas.";
