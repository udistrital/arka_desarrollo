		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			
			{
				...
				if (isset ( $_REQUEST ['mensaje'] ) && $_REQUEST ['mensaje'] == 'confirma') {
					...
					$mensaje = "Se Registro la solicitud de Baja del Elemento <br> # Número Baja : " . $variable. ".<br>Fecha :" . $fechaActual. "<br><br>Se efectuará al momento de realizar Aprobación de Baja.";
