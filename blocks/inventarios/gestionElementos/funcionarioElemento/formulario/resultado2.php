...
class registrarForm {
    ...
    function miForm() {
        ...
        if (isset($_REQUEST ['opcionEspecial']) && $_REQUEST ['opcionEspecial'] != '') {
            $valorE = $_REQUEST ['opcionEspecial'];
        } else {
            $valorE = '';
        }
        var_dump($_REQUEST);

        //CASO DE ENITH MIREYA ZARATEEE


        if (($funcionario != 41762709 && $valorE != '') || ($funcionario == 41762709 && $valorE == 'si')) {
            ...
            $valorCodificado .= "&arregloPDF=" . base64_encode(serialize($resultado));
            if (isset($_REQUEST ['accesoCondor']) && $_REQUEST ['accesoCondor'] == 'true') {
            ...
            $valorCodificado .= "&bloque=" . $esteBloque ['nombre'];
            $valorCodificado .= "&bloqueGrupo=" . $esteBloque ["grupo"];
            $valorCodificado .= "&opcion=validarEspecial";
            $valorCodificado .= "&opcionEspecial=si";
            $valorCodificado .= "&funcionario=" . $_REQUEST ['funcionario'];
            $valorCodificado .= "&usuario=" . $_REQUEST ['usuario'];
            if (isset($_REQUEST ['accesoCondor']) && $_REQUEST ['accesoCondor'] == 'true') {
