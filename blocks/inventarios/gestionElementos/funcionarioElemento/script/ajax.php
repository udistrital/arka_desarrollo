...
<script type='text/javascript'>
    ...
    function consultarEspacio(elem, request, response) {
        $.ajax({
            ...
            dataType: "json",
            data: {valor: $("#<?php echo $this->campoSeguro('dependencia') ?>").val(), sede: $("#<?php echo $this->campoSeguro('sede') ?>").val(),
    ...
    function consultarSede(elem, request, response) {
        $.ajax({
            ...
            dataType: "json",
            data: {funcionario: $("#<?php echo $this->campoSeguro('funcionario') ?>").val()},
            success: function (data) {
    ...
    function consultarDependencia(elem, request, response) {
        $.ajax({
            ...
            dataType: "json",
            data: {valor: $("#<?php echo $this->campoSeguro('sede') ?>").val(), funcionario: $("#<?php echo $this->campoSeguro('funcionario') ?>").val()},
            success: function (data) {
