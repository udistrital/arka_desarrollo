...
// 			$sPhotos .= "<img src='unodepiera.png' alt='unodepiera' />";

            $sPhotos .= '<img src="data:image/gif;base64,' . trim($aItems[$i][0], "\n") . '">, ';
        }
    } else {
        $sPhotos = [
    ...
    if (!empty($resultado)) {
        foreach ($resultado as $key => $values) {
            ...
            $resultadoFinal [] = array(
                ...
                'serie' => "<center>" . $resultado [$key] ['serie'] . "</center>",
