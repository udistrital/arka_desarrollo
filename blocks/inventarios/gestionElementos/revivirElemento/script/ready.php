...
$("#revivirElemento").validationEngine({
...
$('#<?php echo $this->campoSeguro('sede_fun')?>').width(210);
$("#<?php echo $this->campoSeguro('sede_fun') ?>").select2(); 
$('#<?php echo $this->campoSeguro('ubicacion_fun')?>').width(210);
$("#<?php echo $this->campoSeguro('ubicacion_fun') ?>").select2(); 
$('#<?php echo $this->campoSeguro('dependencia_fun')?>').width(210);
...
$('#<?php echo $this->campoSeguro('sede_salida')?>').width(210);
$("#<?php echo $this->campoSeguro('sede_salida') ?>").select2(); 
$('#<?php echo $this->campoSeguro('dependencia_salida')?>').width(210);
