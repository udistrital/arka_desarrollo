...
// lineas para conectar base de d atos-------------------------------------------------------------------------------------------------
        ...
        $leyenda = '# Placa Elemento : ' . $seleccion ['placa'] . '<br>';
        $leyenda .= 'Descripcion : ' . $seleccion ['descripcion_elemento'] . '<br>';
        $leyenda .= 'Sede : ' . $seleccion ['sede'] . '<br>';
        $leyenda .= 'Dependencia: ' . $seleccion ['dependencia'] . '<br>';
        $leyenda .= 'Ubicación  : ' . $seleccion ['ubicacion'] . '<br>';
...
// ---------------- SECCION: Controles del Formulario -----------------------------------------------
            ...
            $atributos ['tipoEtiqueta'] = 'inicio';
            $atributos ["leyenda"] = "Registrar Revivir Elemento";
