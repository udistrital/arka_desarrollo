...
if (! isset ( $GLOBALS ["autorizado"] )) {
	...
	if ($_REQUEST ['mensaje'] == 'CerroPeriodo') {
		
		$tipo = 'success';
		$mensaje = "Se Cerro  Periodo de Levantamiento Conprendido entre fechas " . $_REQUEST ['fecha_inicio'] . " y " . $_REQUEST ['fecha_final'] . ".";
		$boton = "continuar";
	...
	} else if ($_REQUEST ['mensaje'] == 'noCerroPeriodo') {
		$tipo = 'error';
		$mensaje = "No se pudo Cerrar  Periodo de Levantamiento con Exito.<br>Verifique los Datos.";
		$boton = "regresar";
