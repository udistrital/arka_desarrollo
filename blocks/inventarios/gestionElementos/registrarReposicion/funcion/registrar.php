...
class RegistradorOrden {
    ...
    function procesarFormulario() {
        ...
        $entrada = array(
            ...
            'id_ordenador' => $_REQUEST ['nombreOrdenador'],
            'tipo_ordenador' => $_REQUEST ['asignacionOrdenador'],
            'identificacion_ordenador' => $_REQUEST ['nombreOrdenador'],
...
//			$placa = $esteRecursoDB->ejecutarAcceso ( $cadenaSql, "busqueda" );
        ...
        if ($num_placa [0] [0] == 0) {
            for ($i = 0; $i < $_REQUEST ['cantidad']; $i ++) {
                ...
                $cadenaSql = $this->miSql->getCadenaSql('buscar_max_ind', $arregloElementosInv);
                $max_ind = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda", $arregloElementosInv, "ingresar_elemento_individual");

                $cadenaSql = $this->miSql->getCadenaSql('ingresar_elemento_individual', $arregloElementosInv, $max_ind[0][0] + 1);
        ...
        $cadenaSql = $this->miSql->getCadenaSql('consultar_informacion_elemento', $elemento_id_max_indiv [0] [0] + 1);
        ...
        $arreglo = array(
            ...
            'funcionario' => $seleccion['funcionario'],
            'observaciones' => 'Baja por faltante',
            'id_elemento' => $seleccion['id_elemento_ind'],
            'fecha' => $seleccion ['fecha_registro'],
            'sede' => $seleccion['sede'],
        ...
        $registro_baja = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda", $arreglo, "insertar_baja");
