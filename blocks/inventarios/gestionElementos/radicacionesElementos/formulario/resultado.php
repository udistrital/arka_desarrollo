...
class registrarForm {
	...
	function miForm() {
		...
		if (isset ( $_REQUEST ['tipoConsulta'] ) && $_REQUEST ['tipoConsulta'] != '') {
			$tipoInexistencia = $_REQUEST ['tipoConsulta'];
		} else {
			$tipoInexistencia = '';
		}
		
		if (isset ( $_REQUEST ['placaConsulta'] ) && $_REQUEST ['placaConsulta'] != '') {
			$placa = $_REQUEST ['placaConsulta'];
		} else {
			$placa = '';
		}
		...
		$arreglo = array (
				'tipo_inexistencia' => $tipoInexistencia,
				'placa' => $placa,
				'fecha_inicial' => $fechaInicio,
				'fecha_final' => $fechaFinal 
		);
		
		$cadenaSql = $this->miSql->getCadenaSql ( 'consultarSoportesMovimientos', $arreglo );
		...
		$atributos ['tipoEtiqueta'] = 'inicio';
		$atributos ["leyenda"] = "Consultar Radicaciones de Inexistencias  de Elementos";
		...
		if ($soportes) {
			...
			for($i = 0; $i < count ( $soportes ); $i ++) {
				 ...
				 */
				$mostrarHtml = "<tr>
                    <td><center>" . $soportes [$i] ['placaelemento'] . "</center></td>
                    <td><center>" . $soportes [$i] ['tipo_tfs'] . "</center></td>
                    <td><center><a href='" . $soportes [$i] ['ruta_radicacion'] . "' target='_blank'><u>" . $soportes [$i] ['nombre_radicacion'] . "</u></a></center></td>
