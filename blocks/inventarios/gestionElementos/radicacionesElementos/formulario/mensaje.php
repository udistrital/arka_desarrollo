	...
	function miForm() {
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			
			{
				...
				if (isset($_REQUEST ['mensaje'])&&$_REQUEST ['mensaje'] == 'exito') {
					
					$mensaje = "Se Registro con Exito la Radicación de Documento de Movimiento. # Número de Movimiento: " . $_REQUEST ['numero_movimiento'] . "  
				...
				if (isset($_REQUEST ['mensaje'])&&$_REQUEST ['mensaje'] == 'error') {
					...
					$mensaje = "No Se Pudo Hacer  Radicación de Documento de Movimiento";
