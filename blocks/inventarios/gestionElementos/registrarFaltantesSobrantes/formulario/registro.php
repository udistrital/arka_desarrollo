...
class registrarForm {
	...
	function miForm() {
		...
		$leyenda = '# Placa Elemento : ' . $elemento ['placa'] . '<br>';
		$leyenda .= 'Número Salida y/o Vigencia: ' . $elemento ['salidas'] . '&nbsp&nbsp&nbsp<br>';
		$leyenda .= 'Funcionario a Cargo : ' . $funcionario [0] [0] . " - " . $funcionario [0] [1] . '<br>';
		$leyenda .= 'Dependencia  : ' . $elemento ['dependencia'] . '<br>';
		$leyenda .= 'Ubicación Especifica : ' . $elemento ['ubicacion'] . '<br>';
		
		// $funcionario = array (
		// "responsable_ante" => $funcionario [0] [1],
		// "id_elemento" => $funcionario [0] [0],
		// "id_funcionario" => $funcionario [0] [2]
		// )
		// ;
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			$atributos ['tipoEtiqueta'] = 'inicio';
			$atributos ["leyenda"] = "Faltantes y Sobrantes Elementos";
			...
			unset ( $atributos );
			{
				...
				$atributos ['miEvento'] = '';
				$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "tipo_faltante" );
				...
				unset ( $atributos );
				{
					...
					$atributos ['id'] = $esteCampo;
					$atributos ['leyenda'] = "Información Hurto";
					echo $this->miFormulario->agrupacion ( 'inicio', $atributos );
					{
						
						// ------------------Division para los botones-------------------------
						
						$esteCampo = 'fecha_hurto';
						$atributos ['id'] = $esteCampo;
						$atributos ['nombre'] = $esteCampo;
						$atributos ['tipo'] = 'text';
						$atributos ['estilo'] = 'jqueryui';
