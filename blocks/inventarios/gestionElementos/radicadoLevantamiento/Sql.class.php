...
class Sql extends \Sql {
    ...
    function getCadenaSql($tipo, $variable = "", $auxiliar = "", $otro="") {
        ...
        switch ($tipo) {
            ...
            case "Registrar_Radicacion" :
                ...
                $cadenaSql .= "funcionario,sede,dependencia,numero_elementos,estado_radicacion, fecha_registro, ubicacion)  ";
                ...
                $cadenaSql .= "'" . $variable ['cod_espacio'] . "');";
            ...
            case "dependenciasConsultadas" :
                ...
                $cadenaSql .= " WHERE sas.\"ESF_ID_SEDE\"='" . $variable['valor'] . "' AND fun.\"FUN_IDENTIFICACION\"=" . $variable['funcionario'] . " AND ele.tipo_bien<>1";
            ...
            case "UbicacionesConsultadas" :
                ...
                $cadenaSql .= " JOIN arka_parametros.arka_sedes as sas ON sas.\"ESF_COD_SEDE\"=espacios.\"ESF_COD_SEDE\" ";
                $cadenaSql .= " JOIN arka_inventarios.elemento as ele ON ele.id_elemento=eli.id_elemento_gen  ";
                $cadenaSql .= " WHERE ad.\"ESF_CODIGO_DEP\"='" . $variable['dependencia'] . "'  AND fun.\"FUN_IDENTIFICACION\"=" . $variable['funcionario'] . "  AND ele.tipo_bien<>1";
            ...
            case "funcionarios" :
                ...
                $cadenaSql = "SELECT  DISTINCT fun.\"FUN_IDENTIFICACION\", fun.\"FUN_IDENTIFICACION\" ||' - '||  fun.\"FUN_NOMBRE\"       funcionario ";
            ...
            case "ConsultarNombreSedesRadicado" :

                $cadenaSql = "SELECT  \"ESF_SEDE\" ";
                $cadenaSql .= "FROM  arka_parametros.arka_sedes ";
                $cadenaSql .= "WHERE \"ESF_ID_SEDE\"='".$variable."'";
                break;

            case "ConsultarUbicacionRadicado" :

                $cadenaSql = "SELECT  DISTINCT  espacio, codigo_espacio ";
                $cadenaSql .= "FROM  arka_movil.radicados_actuales ";
                $cadenaSql .= "JOIN arka_parametros.arka_dependencia ad ON ad.\"ESF_CODIGO_DEP\"= radicados_actuales.codigo_dependencia";
                $cadenaSql .= " WHERE ad.\"ESF_CODIGO_DEP\"='".$variable."' ";
                $cadenaSql .= "ORDER BY  espacio ASC ;";
                
               
                break;

            case "ConsultarDependenciasRadicado" :

                $cadenaSql = "SELECT  DISTINCT  dependencia, codigo_dependencia ";
                $cadenaSql .= " FROM  arka_movil.radicados_actuales ";
                $cadenaSql .= " WHERE codigo_sede='" . $variable . "'";
                $cadenaSql .= " ORDER BY  dependencia ASC ;";
            ...
            case "consultarFuncionariosaCargoElementos" :
                ...
                if ($variable['sede'] != '') {
                    $cadenaSql .= "AND sas.\"ESF_ID_SEDE\"='" . $variable['sede'] . "' ";
                }
                if ($variable['dependencia'] != '') {
                    $cadenaSql .= "AND ad.\"ESF_CODIGO_DEP\"='" . $variable['dependencia'] . "' ";
                }
                if ($variable['ubicacion'] != '') {
                    $cadenaSql .= "AND espacios.\"ESF_ID_ESPACIO\"='" . $variable['ubicacion'] . "' ";
                }
                $cadenaSql .= "  WHERE   eli.id_elemento_ind NOT IN (SELECT id_elemento_ind FROM estado_elemento) ";
                $cadenaSql .= '	GROUP BY eli.funcionario,sas."ESF_SEDE" ,sas."ESF_ID_SEDE" ,ad."ESF_CODIGO_DEP" ,ad."ESF_DEP_ENCARGADA",espacios."ESF_ID_ESPACIO",espacios."ESF_NOMBRE_ESPACIO",fun."FUN_NOMBRE") eli_cla ';
                ...
                $cadenaSql .= 'AND rc.dependencia=eli_cla.codigo_dependencia AND rc.ubicacion=eli_cla.codigo_espacio ';
                $cadenaSql .= 'ORDER BY codigo_dependencia ; ';
         
                        
                break;

            case "consultarFuncionariosaCargoElementos2" :
                ...
                $cadenaSql .= ' AND eli.funcionario <> 0  ';
                if ($variable != '') {
                    $cadenaSql .= "AND sas.\"ESF_ID_SEDE\"='" . $variable . "' ";
                }
                if ($auxiliar != '') {
                    $cadenaSql .= "AND ad.\"ESF_CODIGO_DEP\"='" . $auxiliar . "' ";
                }
                if ($otro != '') {
                    $cadenaSql .= "AND espacios.\"ESF_ID_ESPACIO\"='" . $otro . "' ";
                }
                $cadenaSql .= "  WHERE   eli.id_elemento_ind NOT IN (SELECT id_elemento_ind FROM estado_elemento) ";
                $cadenaSql .= '	GROUP BY eli.funcionario,sas."ESF_SEDE" ,sas."ESF_ID_SEDE" ,ad."ESF_CODIGO_DEP" ,ad."ESF_DEP_ENCARGADA",espacios."ESF_ID_ESPACIO",espacios."ESF_NOMBRE_ESPACIO",fun."FUN_NOMBRE") eli_cla ';
                $cadenaSql .= ' LEFT JOIN arka_movil.radicado_levantamiento rc ON rc.funcionario=eli_cla.identificacion ';
