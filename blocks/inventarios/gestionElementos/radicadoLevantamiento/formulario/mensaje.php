	...
	function miForm() {
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			
			{
				...
				if ($_REQUEST ['mensaje'] == 'Nofuncionario') {
						
					$mensaje = "No Selecciono Ninguna Radicación de Ningun  Funcionario<br>Verifique los Datos";
				...
				if ($_REQUEST ['mensaje'] == 'Radicado') {
						
					$mensaje = "Se han Guardado los Radicados de Funcionarios de Inventario Referentes a Levantamiento Físico";
				...
				if ($_REQUEST ['mensaje'] == 'noRadicado') {
				
					$mensaje = "Error al Guardar Radicados de  Levantamiento Inventarios Físicos";
