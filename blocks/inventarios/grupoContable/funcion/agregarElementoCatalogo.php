...
namespace arka\grupoContable\agregarElementoCatalogo;
...
class Formulario {
	...
	public function validarEntrada() {
		...
		// id padre existe
		$cadena_sql = $this->sql->getCadenaSql ( "buscarIdPadre", array (
				$_REQUEST ['idPadre'],
				$_REQUEST ['idCatalogo'] 
		) );
		$registros = $this->esteRecursoDB->ejecutarAcceso ( $cadena_sql, "busqueda" );
		...
		$cadena_sql = $this->sql->getCadenaSql ( "buscarIdElemento", array (
				$_REQUEST ['id'],
				$_REQUEST ['idPadre'],
				$_REQUEST ['idCatalogo'] 
		) );
		...
		$cadena_sql = $this->sql->getCadenaSql ( "buscarNombreElementoNivel", array (
				$_REQUEST ['id'],
				$_REQUEST ['idPadre'],
				$_REQUEST ['idCatalogo'],
