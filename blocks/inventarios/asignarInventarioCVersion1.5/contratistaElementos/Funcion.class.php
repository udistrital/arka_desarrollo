...
namespace inventarios\asignarInventarioC\contratistaElementos;
	...
	function action() {
		...
		if (isset ( $_REQUEST ['procesarAjax'] )) {
			...
			if ($_REQUEST ['opcion'] == 'asignar') {
				...
				if (isset ( $_REQUEST ['botonAceptar'] ) && $_REQUEST ['botonAceptar'] == 'true') {
					
					$this->asignarInventario ();
				} else if (isset ( $_REQUEST ['botonDocumentoSoporte'] ) && $_REQUEST ['botonDocumentoSoporte'] =='true') {
