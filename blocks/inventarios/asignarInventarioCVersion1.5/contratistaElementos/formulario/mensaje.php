...
class registrarForm {
	...
	function miForm() {
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			$variable .= "&opcion=consultarContratista";
			...
			
			{
				if (isset($_REQUEST ['mensaje'])&&$_REQUEST ['mensaje'] == 'confirma') {
					...
					$mensaje = "Se Guardaron los Cambios en el Inventario del Contratista <br>con Identificación  Número  ".$_REQUEST['identificacion'];
