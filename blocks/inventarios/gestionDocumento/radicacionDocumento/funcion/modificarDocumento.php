...
class RegistradorOrden {
    ...
    function procesarFormulario() {
        ...
        if ($archivo ['name'] != '') {
            ...
            if ($TipoDocumento != $_REQUEST['tipo_documento_original'] || $serial != $_REQUEST['consecutivo_documento_original']) {
        ...
        $cadenaSql = $this->miSql->getCadenaSql('actualizarRadicacion', $arregloDatos);
        $Radicacion = $esteRecursoDB->ejecutarAcceso($cadenaSql, "busqueda");


        if ($Radicacion != false) {

            redireccion::redireccionar('actualizo', $arreglo);
            exit;
        } else {

            redireccion::redireccionar('noActualizo', $arreglo);
            exit;
        }
    }
