...
$("#radicacionDocumento").validationEngine({
...
$(function() {
$("#radicacionDocumento").submit(function() {
$resultado=$("#radicacionDocumento").validationEngine("validate");
...
$('#<?php echo $this->campoSeguro('tipo_documento') ?>').width(210);
$("#<?php echo $this->campoSeguro('tipo_documento') ?>").select2();
