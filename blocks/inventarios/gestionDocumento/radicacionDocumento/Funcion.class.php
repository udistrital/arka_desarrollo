...
class Funcion {
	...
	function regitrar() {
       ...
       function registrarDocumento() {
		include_once ($this->ruta . "funcion/registrarDocumento.php");
	}
        function modificarDocumento() {
		include_once ($this->ruta . "funcion/modificarDocumento.php");
	}
        function clasificar() {
		include_once ($this->ruta . "funcion/clasificar.php");
	}
        function opcion() {
		...
		if (isset ( $_REQUEST ['procesarAjax'] )) {
			...
			if ($_REQUEST ['opcion'] == 'registrar') {
				$this->regitrar();
                        ...
                        if ($_REQUEST ['opcion'] == 'ConsultarElemento') {
				$this->opcion();
			}
                        if ($_REQUEST ['opcion'] == 'solicitarClasificacion') {
				$this->clasificar();
			}
                        if ($_REQUEST ['opcion'] == 'registrarDocumento') {
				$this->registrarDocumento();
			}
                        if ($_REQUEST ['opcion'] == 'modificarDocumento') {
