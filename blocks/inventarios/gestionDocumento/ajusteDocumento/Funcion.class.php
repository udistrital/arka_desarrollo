...
class Funcion {
	...
	function regitrar() {
		include_once ($this->ruta . "funcion/registrar.php");
         ...
         function regitrarModificar() {
		include_once ($this->ruta . "funcion/modificar.php");
	}
        function revisionModificar() {
		include_once ($this->ruta . "funcion/modificarRevision.php");
	}
	function action() {
		...
		if (isset ( $_REQUEST ['procesarAjax'] )) {
			...
			if ($_REQUEST ['opcion'] == 'registrar') {
				$this->regitrar();
                        ...
                        if ($_REQUEST ['opcion'] == 'registrarModificacion') {
				$this->regitrarModificar();
			}
                        if ($_REQUEST ['opcion'] == 'modificarRevision') {
				$this->revisionModificar();
			}
