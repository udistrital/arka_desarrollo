...
class registrarForm {
    ...
    function miForm() {
        ...
        if (isset($_REQUEST ['variableId']) && $_REQUEST ['variableId'] != '') {
            $vigencia = $_REQUEST ['variableId'];
        } else {
            $vigencia = '';
        }

        $cadenaSql = $this->miSql->getCadenaSql('consultarElementosxDocumentoID', $vigencia);
        ...
        echo $this->miFormulario->formulario($atributos); {
            ...
            $atributos ['tipoEtiqueta'] = 'inicio';
            $atributos ["leyenda"] = "Modificar Elemento";
            ...
            unset($atributos); {
                ...
                unset($atributos); {
                    ...
                    echo $this->miFormulario->agrupacion('inicio', $atributos); {
                        ...
                        $atributos ['seleccion'] = $elemento[0]['nivel'];
                        ...
                        if (isset($_REQUEST [$esteCampo])) {
                            ...
                            $atributos ['valor'] = $elemento[0]['nombre_tipo'];
                        }
                        ...
                        unset($atributos); {
                            ...
                            if (isset($_REQUEST [$esteCampo])) {
                                ...
                                $atributos ['valor'] = $elemento[0]['serie'];
                            }
                            $atributos ['titulo'] = $this->lenguaje->getCadena($esteCampo . 'Titulo');
                            $atributos ['deshabilitado'] = true;
                            ...
                            if (isset($_REQUEST [$esteCampo])) {
                                ...
                                $atributos ['valor'] = $elemento[0]['marca'];
                            }
                            $atributos ['titulo'] = $this->lenguaje->getCadena($esteCampo . 'Titulo');
                            $atributos ['deshabilitado'] = true;
                            $atributos ['tamanno'] = 15;
                        ...
                        if (isset($_REQUEST [$esteCampo])) {
                            ...
                            $atributos ['valor'] = $elemento[0]['descripcion'];
                        }
                        $tab ++;
                        ...
                        $atributos ['tabIndex'] = $tab;
                        $atributos ['etiqueta'] = $this->lenguaje->getCadena($esteCampo);
                        $atributos ['validar'] = 'required, minSize[1],maxSize[15],custom[number]';

                        if (isset($_REQUEST [$esteCampo])) {
                            $atributos ['valor'] = $_REQUEST [$esteCampo];
                        } else {
                            $atributos ['valor'] = $elemento[0]['cantidad'];
                        }
                        $atributos ['titulo'] = $this->lenguaje->getCadena($esteCampo . 'Titulo');
                        ...
                        if (isset($_REQUEST [$esteCampo])) {
                            ...
                            $atributos ['valor'] = $elemento[0]['unidad'];
                        }
                        $atributos ['titulo'] = $this->lenguaje->getCadena($esteCampo . 'Titulo');
                        $atributos ['deshabilitado'] = false;
                        $atributos ['tamanno'] = 10;
                        ...
                        $atributos ['tabIndex'] = $tab;
                        $atributos ['etiqueta'] = $this->lenguaje->getCadena($esteCampo);
                        $atributos ['validar'] = 'required, minSize[1],min[0],maxSize[30],custom[number]';
                        if (isset($_REQUEST [$esteCampo])) {
                            $atributos ['valor'] = $_REQUEST [$esteCampo];
                        } else {
                            $atributos ['valor'] = $elemento[0]['valor'];
                        }
                        $atributos ['titulo'] = $this->lenguaje->getCadena($esteCampo . 'Titulo');
                        $atributos ['deshabilitado'] = false;
                        $atributos ['tamanno'] = 10;
                        ...
                        $atributos ['nombre'] = $esteCampo;
                        $atributos ['id'] = $esteCampo;
                        $atributos ['seleccion'] = $elemento[0]['iva'];
                        $atributos ['evento'] = '';
                        $atributos ['deshabilitado'] = false;
                        $atributos ["etiquetaObligatorio"] = true;
                        $atributos ['tab'] = $tab;
                        ...
                        if (isset($_REQUEST [$esteCampo])) {
                            ...
                            $atributos ['valor'] = $elemento[0]['subtotal_sin_iva'];
                        }
                        $atributos ['titulo'] = $this->lenguaje->getCadena($esteCampo . 'Titulo');
                        $atributos ['deshabilitado'] = true;
                        $atributos ['tamanno'] = 10;
                        ...
                        if (isset($_REQUEST [$esteCampo])) {
                            ...
                            $atributos ['valor'] = $elemento[0]['total_iva'];
                        }
                        $atributos ['titulo'] = $this->lenguaje->getCadena($esteCampo . 'Titulo');
                        $atributos ['deshabilitado'] = true;
                        $atributos ['tamanno'] = 10;
                        ...
                        if (isset($_REQUEST [$esteCampo])) {
                            ...
                            $atributos ['valor'] = $elemento[0]['total_iva_con'];
                        }
                        $atributos ['titulo'] = $this->lenguaje->getCadena($esteCampo . 'Titulo');
                        $atributos ['deshabilitado'] = true;
                        $atributos ['tamanno'] = 10;
            ...
            $valorCodificado .= "&opcion=registrarModificacion";
            $valorCodificado .= "&id_elemento=" . $vigencia;
