...
$("#ajusteDocumento").validationEngine({
...
$(function() {
$("#ajusteDocumento").submit(function() {
$resultado=$("#ajusteDocumento").validationEngine("validate");
