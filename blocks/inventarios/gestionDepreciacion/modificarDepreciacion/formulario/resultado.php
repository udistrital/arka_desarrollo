...
class registrarForm {
    ...
    function miForm() {
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Histórico Depreciación ";
        ...
        if ($elementos !== false) {
            ...
            for ($i = 0; $i < count($elementos); $i ++) {
                ...
                $mostrarHtml = "<tr>
                    ...
                    <td><center>" . $elementos [$i]['dep_fechacorte'] . "</center></td>
                    <td><center>" . $elementos [$i]['dep_cantidad'] . "</center></td>
                    <td><center>" . $elementos [$i]['dep_precio'] . "</center></td>
