...
// ---------------- SECCION: Controles del Formulario -----------------------------------------------
            ...
            $atributos ['tipoEtiqueta'] = 'inicio';
            $atributos ["leyenda"] = "Modificar Depreciación Elemento General ID.".$_REQUEST['item'];
...
// // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                    ...
                    if (isset($datos_elemento[0]['fechasalida'])) {
                        $atributos ['valor'] = $datos_elemento[0]['fechasalida'];
                    } else {
                        $atributos ['valor'] = '';
                    }
                    $atributos ['titulo'] = $this->lenguaje->getCadena($esteCampo . 'Titulo');
...
// --------------- FIN CONTROL : Cuadro de Texto --------------------------------------------------
                    // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                    $esteCampo = 'depreciacion_acumulada';
                    $atributos ['id'] = $esteCampo;
                    $atributos ['nombre'] = $esteCampo;
                    $atributos ['tipo'] = 'text';
                    $atributos ['estilo'] = 'jqueryui';
...
// --------------- FIN CONTROL : Cuadro de Texto --------------------------------------------------
                    // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                    $esteCampo = 'circular_depreciacion';
                    $atributos ['id'] = $esteCampo;
                    $atributos ['nombre'] = $esteCampo;
                    $atributos ['tipo'] = 'text';
                    $atributos ['estilo'] = 'jqueryui';
