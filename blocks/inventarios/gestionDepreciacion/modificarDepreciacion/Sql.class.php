...
//-----------------------------** Cláusulas del caso de uso**----------------------------------//
            ...
            case "modificarDepreciacion":
                $cadenaSql = " UPDATE registro_depreciacion SET";
                $cadenaSql.= " dep_grupocontable='" . $variable['grupo_contable'] . "', ";
                $cadenaSql.= " dep_meses='" . $variable['meses_depreciar'] . "', ";
                $cadenaSql.= " dep_fechasalida='" . $variable['fechaSalida'] . "', ";
                $cadenaSql.= " dep_fechacorte='" . $variable['fechaCorte'] . "', ";
                $cadenaSql.= " dep_cantidad='" . $variable['cantidad'] . "', ";
                $cadenaSql.= " dep_precio='" . $variable['precio'] . "', ";
                $cadenaSql.= " dep_valorhistorico='" . $variable['valor_historico'] . "', ";
                $cadenaSql.= " dep_valorajustado='" . $variable['valor_ajustado'] . "', ";
                $cadenaSql.= " dep_cuota='" . $variable['cuota'] . "', ";
                $cadenaSql.= " dep_periodo='" . $variable['periodos_fecha'] . "', ";
                $cadenaSql.= " dep_depacumulada='" . $variable['depreciacion_acumulada'] . "', ";
                $cadenaSql.= " dep_circular56='" . $variable['circular_56'] . "', ";
                $cadenaSql.= " dep_cuotainflacion='" . $variable['cuota_inflacion'] . "', ";
                $cadenaSql.= " dep_apicacumulada='" . $variable['api_acumulada'] . "', ";
                $cadenaSql.= " dep_circulardeprecia='" . $variable['circular_depreciacion'] . "', ";
                $cadenaSql.= " dep_libros='" . $variable['valor_libros'] . "', ";
