...
namespace inventarios\reversaContable;
...
//-----------------------------** Cláusulas del caso de uso**----------------------------------//
            case "consultarCierres":
                $cadenaSql = " SELECT id_cierre, cierre_fecha_inicio, cierre_fecha_final, fecha_cierre ";
                $cadenaSql.= " FROM cierre_contable ";
                $cadenaSql.= " WHERE estado_registro='TRUE'";
                if ($variable ['vigencia'] != '') {
                    $cadenaSql .= " AND vigencia_cierre = '" . $variable ['vigencia'] . "'";
                }

                if ($variable['fecha_inicio'] != '' && $variable ['fecha_final'] != '') {
                    $cadenaSql .= " AND cierre_fechainicio BETWEEN CAST ( '" . $variable ['fecha_inicio'] . "' AS DATE) ";
            ...
            case "actualizarEntrada":
                ...
                $cadenaSql.= " SET cierre_contable='FALSE' ";
                $cadenaSql.= " WHERE id_cierrecontable='" . $variable['id_cierre'] . "' ";
                break;
