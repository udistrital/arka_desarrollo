...
define('SW_PROJECT_PASSWORD', 'arkaInventarios');
...
define('SW_PROJECT_TITLE', 'Sistema Gestion de Inventarios');
...
define('SW_DB_PASSWORD', '2ip_5zsuv7xta6r=');
define('SW_DB_HOST', '10.20.0.22');
