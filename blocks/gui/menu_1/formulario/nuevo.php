...
$enlaceRegistroOrdenServicios ['nombre'] = "Registrar Orden";



// Elementos Orden 
$enlaceElementosOrden ['enlace'] = "pagina=registrarElementoOrden";
$enlaceElementosOrden ['enlace'] .= "&usuario=" . $miSesion->getSesionUsuarioId();

$enlaceElementosOrden ['urlCodificada'] = $this->miConfigurador->fabricaConexiones->crypto->codificar_url($enlaceElementosOrden ['enlace'], $directorio);
$enlaceElementosOrden ['nombre'] = "Registrar Elementos Orden";
...
$enlaceConsultaOrdenServicios ['nombre'] = "Consultar y Modificar Orden";
...
$enlaceGestionarGrupoC ['nombre'] = "Grupo Manejo de Bienes";
...
$enlacedepreciacionGeneral ['nombre'] = "Generar Depreciación por Grupo ";
            ...
            <div class="cbp-hrsub">
                <div class="cbp-hrsub-inner"> 
                  <!--   <div>
                    ...
                    <div>
                        <h4>Orden de Compra o Servicios</h4>
                        <ul>
                            <li><a href="<?php echo $enlaceRegistroOrdenServicios['urlCodificada'] ?>"><?php echo $enlaceRegistroOrdenServicios['nombre'] ?></a></li>
                            <li><a href="<?php echo $enlaceElementosOrden['urlCodificada'] ?>"><?php echo $enlaceElementosOrden['nombre'] ?></a></li>
