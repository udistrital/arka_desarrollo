...
$enlaceGestionarGrupoC ['nombre'] = "Grupos Manejo de Bienes";
...
<nav id="cbp-hrmenu" class="cbp-hrmenu">
    ...
    <li>
            ...
            <div class="cbp-hrsub">
                <div class="cbp-hrsub-inner"> 
                    <div>
                        <h4>Descargar ARKA Móvil</h4>
                        <ul>
                            <li><a href="http://10.20.0.38/ws_arka_android/com.arkamovil.android-2%20(2).apk">Obtener APK</a></li>
                        </ul>
                    </div>
                </div><!-- /cbp-hrsub-inner -->
            </div><!-- /cbp-hrsub -->
