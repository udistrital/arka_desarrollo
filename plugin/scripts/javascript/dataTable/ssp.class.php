...
class SSP {
	 ...
	 */
	static function simple($request, $conn, $table, $primaryKey, $columns, $myJoin, $myWhere) {
		$bindings = array ();
		$db = self::db ( $conn );
	...
	static function sql_connect($sql_details) {
		try {
			$db = @new PDO ( "pgsql:host={$sql_details['host']};dbname={$sql_details['db']}", $sql_details ['user'], $sql_details ['pass'], array (
